...
- The Fairface dataset was orginally trained on resnet50(containing ~ 25millions parameters), which has ~2000 times more parameters more than my model. In my problem, i used less images and simpler model to fit a more specific purpose, leading to faster computing time but lower performance
